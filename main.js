...
window.onload = function ()
{
	...
	function startDrag(x, y)
	{
		...
		if (sphereHitTest)
		{
			console.log("startDrag[sphereHitTest]");
		...
		{
			mode = MODE_ADD_DROPS;
			console.log("startDrag[!sphereHitTest] -> change mode = mode_add_drops. goto during drag.");
			duringDrag(x, y);
		} else
		{
	...
	function duringDrag(x, y)
	{
		...
		switch (mode)
		{
			case MODE_ADD_DROPS:
			{
				// TODO - Here we add the drop and change the normals.
